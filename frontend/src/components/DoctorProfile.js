...
const UserProfile = () => {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            ...
            try {
                const response = await axios.get('http://127.0.0.1:8000/api/user-doctor/', {
                    headers: {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            await axios.put('http://127.0.0.1:8000/api/user-doctor/update-doctor', dataToSend, {
                headers: {
                    'Authorization': `Token ${token}`
                }
            });
    ...
    const handleDeleteAccount = async () => {
        ...
        try {
            await axios.delete('http://127.0.0.1:8000/api/delete-doctor/', {
                headers: {
                    'Authorization': `Token ${token}`
                }
            });
